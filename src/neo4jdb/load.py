...
class Neo4jTPCH:
    ...
    async def asetup(self) -> None:
        ...
        await self.asetup_indices()

    async def asetup_indices(self) -> None:
    ...
    async def batch_load(self, query: str, data: list[dict], table_name: str, batch_size: int = 1000) -> None:
    ...
    async def aload_region(self):
        ...
        """
        await self.batch_load(query, data, "Region")

    async def aload_nation(self):
        """Load nation.tbl"""
        ...
        """
        await self.batch_load(query, data, "Nation")

    async def aload_supplier(self):
        """Load supplier.tbl"""
        ...
        """
        await self.batch_load(query, data, "Supplier")

    async def aload_customer(self):
        ...
        """
        await self.batch_load(query, data, "Customer")

    async def aload_part(self):
        """Load part.tbl"""
        ...
        """
        await self.batch_load(query, data, "Part")

    async def aload_partsupp(self):
        """Load partsupp.tbl"""
        ...
        """
        await self.batch_load(query, data, "PartSupp")

    async def aload_orders(self):
        """Load orders.tbl"""
        ...
        query = """
            ...
            MERGE (c)-[:PLACED]->(o)
        """
        await self.batch_load(query, data, "Orders")

    async def aload_lineitem(self):
        """Load lineitem.tbl"""
        ...
        """
        await self.batch_load(query, data, "LineItem")
